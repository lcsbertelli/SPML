...
def get_loss_function(loss):
    ...
    #print("loss function in get_loss",loss_fn)
    ...
    #print("loss name",loss_fn.__name__)
...
def prepare_loss_functions(loss, output_names):
    ...
    """
    #print("in training utils prepare_loss_functions",loss)
    if isinstance(loss, collections.Mapping):
        generic_utils.check_for_unexpected_keys('loss', loss, output_names)
        loss_functions = []
        #print(" just output_names", output_names)
        for name in output_names:
            if name not in loss:
                warnings.warn(
        ...
        #print("collections.Sequence",collections.Sequence)
    else:
        #print("in else")
        loss_functions = [get_loss_function(loss) for _ in range(len(output_names))]
    #print("loss_function",loss_functions)
